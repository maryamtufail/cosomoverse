  ...
  return (
    <div className="xl:flex w-full relative z-10 pt-56 sm:pt-[400px]">
      ...
      >
        ...
        >
          Community-Driven and Empowering
        </motion.div>
        <motion.div
        ...
        >
          Embark on a Journey through a Connected Uni.
        </motion.div>
        <motion.div
      ...
      >
        <motion.div variants={textVariant(0.5, 1)}>
          <div className="font-helve font-normal text-[90px] sm:text-[117px] leading-[139px] text-transparent bg-clip-text bg-gradient-to-br from-white to-gray-500">
            265+
          </div>
          <TypingText
            title="App & Services"
            textStyles="font-dm font-normal text-[25px] sm:text-[30px] leading-10"
          />
        </motion.div>
