    ...
    return (
        <div className="flex-col w-full relative z-10 pt-56 sm:pt-[400px]">
            ...
            >
                ...
                >
                    The Core of Interchain Connectivity.
                </motion.div>
                <motion.div
                ...
                >
                    As the economic nucleus of CosmoVerse, the Cosmo Hub blockchain delivers essential services to facilitate interchain operations.
                </motion.div>
            </motion.div>
                ...
                >
                    <Button>
                        <div className="flex py-5 px-6 sm:px-14 sm:py-8">
                            <span className="flex justify-center items-center font-dm font-normal text-[16px] md:text-[20px]">Explore Cosmo Hub</span>
