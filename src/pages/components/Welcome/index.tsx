...
import { HedronType } from '@/utils/typesUtils';
    ...
    return (
        ...
        >
            ...
            <motion.div
                ...
                className="flex relative z-10 justify-center text-xl sm:text-2xl font-normal font-dm opacity-60 tracking-widest text-white uppercase"
            >
            ...
            >
                Power of the Blockchains

            </motion.div>
            <motion.div
                variants={textVariant(0.8, 1)}
                className="flex relative z-10 justify-center text-lg sm:text-xl md:text-3xl font-dm font-normal tracking-[0.01em] leading-7 md:leading-10 px-8 sm:px-16 md:px-28 lg:px-56 text-center text-white"
            >
                CosmoVerse is a thriving ecosystem of interconnected apps and services designed to shape a decentralized future.
            </motion.div>
